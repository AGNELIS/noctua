...
const PRODUCT_PL: Record<string, { name: string; desc: string }> = {
  ...
  "First Reflection": { name: "Pierwsza refleksja", desc: "Krótki osobisty odczyt AI po pierwszych pięciu wpisach. Odzwierciedlenie tego co już zapisałaś, zanim uzbierasz materiał na pełny odczyt." },
            ...
            <button
              onClick={() => {
                const routes: Record<string, string> = {
                  ...
                  "First Reflection": "/reports?tab=weekly",
