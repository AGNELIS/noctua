...
const PRODUCT_PL: Record<string, { name: string; desc: string }> = {
  ...
  "Full Reading": { name: "Pełen odczyt", desc: "Głęboki osobisty raport analizujący wzorce z dziennika, symbole snów, dane cyklu i fazy księżyca. To nie jest raport. To jest czytanie Ciebie." },
  ...
  "Reflection": { name: "Refleksja", desc: "Krótki osobisty odczyt AI oparty na Twoich ostatnich wpisach. Odzwierciedlenie tego co zapisałaś w dzienniku, snach i pracy z cieniem. Możesz go generować wielokrotnie, kiedy chcesz zatrzymać się i zobaczyć co mówi materiał który właśnie powstał." },
