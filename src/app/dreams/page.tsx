  ...
  return (
    <div className="min-h-screen relative transition-colors duration-500" style={{ background: "var(--color-gradient)" }}>
      ...
      <header className="px-6 pt-5 pb-2">
        ...
        <h1 className="text-lg md:text-xl tracking-[0.25em] uppercase text-center mt-3" style={{ color: "var(--color-plum)", fontFamily: "'Antic Didone', Georgia, serif", fontWeight: 400 }}>{t("dreams_title")}</h1>
      </header>
